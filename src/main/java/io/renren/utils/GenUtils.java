...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("template/finance/Model.java.vm");
        templates.add("template/finance/Dto.java.vm");
        templates.add("template/finance/Mapper.xml.vm");

        templates.add("template/menu.sql.vm");

        templates.add("template/finance/Service.java.vm");
        templates.add("template/finance/ServiceImpl.java.vm");
        templates.add("template/finance/Controller.java.vm");
        templates.add("template/finance/Mapper.java.vm");
...
//    }
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("MongoChildrenModel.java.vm")) {
            return packagePath + "model" + File.separator + "inner" + File.separator + currentTableName+ File.separator + splitInnerName(className)+ "Inner.java";
        }
        if (template.contains("Model.java.vm") || template.contains("MongoModel.java.vm")) {
            return packagePath + "model" + File.separator + className + ".java";
        }
        if (template.contains("Dto.java.vm")) {
            return packagePath + "model"+ File.separator+ "dto" + File.separator +"Query"+ className + "Dto.java";
        }
